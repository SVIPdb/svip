    ...
    <div class="container">
        <div class="row">
            <div class="col-md-9 offset-1 mt-1">
                <h1>Releases</h1>
                <p>
                    The current SVIP release is
                    <b>{{ appVersion }} ({{ releaseName }})</b>. The full
                    changelog with each version is listed below.
                </p>

                <div
                    v-for="(release, code) in releases"
                    class="release"
                    :key="code"
                >
                    ...
                    <div class="release-body">
                        <div v-if="release.changes">
                            <h4>
                                <expander v-model="release.significant"
                                    >Significant Changes</expander
                                >
                            </h4>
                            ...
                            <b-collapse :visible="release.significant">
                                <ul class="changelog">
                                    <li
                                        v-for="(entry, idx) in release.changes"
                                        :key="idx"
                                    >
                                        {{ entry }}
                                    </li>
                        ...
                        <div v-if="release.changelog">
                            ...
                            <b-collapse :visible="release.full">
                                <ul class="changelog">
                                    <li
                                        v-for="commit in release.changelog"
                                        :key="commit.commit"
                                    >
                                        <b
                                            v-b-tooltip="
                                                `${commit.author.name} on ${commit.author.date} [${commit.abbreviated_commit}]`
                                            "
                                        >
                                            {{
                                                relativeDate(
        ...
        return {
            ...
            releases: {
                "1.3.0": {
                    name: "Init Expo",
                    summary:
                        "Released on 17.12.2021, this includes the reviewer interface and a submit variant feature.",
                    changes: [
                    ...
                    significant: true,
                    full: false,
                    changelog: v130_commits,
                },
                "1.0.0": {
                    name: "Beta Aleph",
                    summary:
                        "Released on 20.10.2020, this is the first feature-complete public release.",
                    changes: [
                    ...
                    significant: true,
                    full: false,
                    changelog: v100_commits,
                },
                "0.9.0": {
                    name: "Alpha Zett",
                    summary:
                        "Released on 01.06.2020, this release includes a lot of small polishes in anticipation of the public release.",
                    changes: [
                    ...
                    significant: true,
                    full: false,
                    changelog: v090_commits,
                },
                "0.3.0": {
                    name: "Alpha Centauri",
                    summary:
                        "Released on 10.02.2020, this release includes a work-in-progress curation interface as well as many small tweaks and bugfixes.",
                    changes: [
                    ...
                    significant: true,
                    full: false,
                    changelog: v030_commits,
                },
                "0.2.0": {
                    name: "Alpha Bump",
                    summary:
                        "Released on 18.07.2019, this release includes an initial mockup of the clinical interface plus many small fixes.",
                    changes: [
                    ...
                    significant: true,
                    full: false,
                    changelog: v020_commits,
                },
                "0.1.0": {
                    name: "Alpha Asterisk",
                    summary:
                        "This is the first SVIP release, published on 07.02.2019.",
                    changes: [

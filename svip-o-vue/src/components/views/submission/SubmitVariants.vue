    ...
    <b-container fluid class="pt-3">
        <b-row>
            <b-col md="12">
                ...
                <p>
                    You can submit variants for us to add to the SVIP database here.
                    Submitted variants are entered into a queue, which will be processed
                    when the variant harvesting pipeline is run.
                </p>

                <p>
                    You can check the status of all submitted variants, including your own,
                        ...
                        <b-tab title="Submit Variants">
                            <div class="m-3">
                                <b-form-radio-group v-model="submitMode">
                                    ...
                                    <b-form-radio value="vcf">Upload a VCF with multiple variants</b-form-radio>
                                </b-form-radio-group>
                            </div>
                                ...
                                <b-form @submit.stop.prevent="submitVariant">
                                    <b-row class="p-0 m-0">
                                        <b-col md="4" class="p-0">
                                            ...
                                            <b-form-group label="Position (GRCh37)" description="the position within the selected chromosome">
                                                <b-input type="number" v-model="pos" />
                                            </b-form-group>

                                            <b-form-group label="Ref" description="The reference base(s) at the position, in VCF (v4.0) format">
                                            ...
                                            <b-form-group label="Alt">
                                                ...
                                                <b-form-text>
                                                    The changed base(s) at the position, in VCF (v4.0) format.<br />
                                                    Use a period (.) to indicate a deletion, and commas to indicate multiple mappings.
                                                </b-form-text>
                                            </b-form-group>
                                                ...
                                                <b-form @submit.stop.prevent="mapHGVS" class="mb-4">
                                                    <b-form-group label="Map HGVS to Pos/Ref/Alt">
                                                        <template slot="description">
                                                            <div>
                                                                Convert this HGVS string (either genomic or coding) identifying a SNP to VCF format,
                                                                filling the fields with the result.
                                                            </div>
                                                            <div class="mt-2">Coding HGVS strings will be converted to genomic strings.</div>
                                                        </template>

                                                        <b-form-input type="text" name="hgvs_str" placeholder="e.g., NM_001637.3:c.1582G>A" v-model="hgvs_str" />
                                                    </b-form-group>

                                                    <div class="d-flex align-items-center">
                                                        <b-button variant="warning" type="submit" :disabled="!hgvs_str || loading_hgvs">
                                    ...
                                    <b-row class="p-0 m-0">
                                        <b-col md="8" class="p-0">
                                            ...
                                            <b-button variant="success" type="submit" :disabled="!all_fields_valid">Submit Variant</b-button>
                                        </b-col>
                                    </b-row>
                                </b-form>
                            </div>
                            ...
                            <div class="m-3" v-if="submitMode === 'vcf'">
                                ...
                                <b-form @submit.stop.prevent="uploadVCF">
                                    ...
                                    <b-button variant="info" type="submit" :disabled="!vcf_file" >Upload VCF</b-button>
                                </b-form>
                            </div>
                        </b-tab>
                        <b-tab title="Submission Queue">
                            <template slot="title">
                                Submission Queue <b-badge v-if="numRowsInQueue !== null">{{ numRowsInQueue }}</b-badge>
                            </template>
                            <SubmissionQueue
                                has-header
                                ...
                                small
                                @data-loaded="(data) => { numRowsInQueue = data.count; }"
                            />
                        </b-tab>
                    </b-tabs>
                </b-card>
...
export default {
    ...
    methods: {
        ...
        uploadVCF() {
            ...
            HTTP.post(`/submitted_variant_batches/`, payload, { headers: { 'Content-Type': 'multipart/form-data' } })
                .then(result => {

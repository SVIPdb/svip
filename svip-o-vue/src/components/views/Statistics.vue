    ...
    <div class="container">
        <div class="row">
            <div class="col-md-10 offset-1">
                ...
                <p>
                    {{
                        $t(
                            "SVIP incorporates data both from public databases and expert curation. This page gives an overview"
                        )
                    }}
                    {{
                        $t(
                            "of how many genes and variants we're tracking, and from where the data originates."
                        )
                    }}
                </p>
            </div>
        ...
        <div class="row">
            <div class="col-md-10 offset-1">
                ...
                <div v-else>
                    ...
                    <b-table
                        :fields="genes_variants_fields"
                        :items="genes_variants_rows"
                        :per-page="genes.perPage"
                        :current-page="genes.currentPage"
        ...
        <div class="row" v-if="showHarvestRuns">
            <div class="col-md-10 offset-1">
                ...
                <div v-else>
                    <div>
                        {{ $t("Showing") }} <b>{{ harvests.perPage }}</b>
                        {{ $t("out of") }} <b>{{ harvests.data.length }}</b>
                        {{ $t("entries") }}
                    </div>

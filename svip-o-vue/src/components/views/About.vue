                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <p>{{ $t("The Swiss Variant Interpretation Platform for Oncology (SVIP-O) aims at providing a centralized,")}}
                                    ...
                                    {{ $t("related institutions (e.g. pathology institutes).")}}</p>
                            </div>
                        </div>
                    </div>
                </section>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="text-justify">
                                    <p>{{ $t("Clinicians in oncology and hemato-oncology are daily confronted with the challenge of")}}
                                        {{ $t("interpreting genetic variants using an increasing number of public knowledge sources, which")}}

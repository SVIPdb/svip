<template>
    <div class="container">
        <div class="col-12">
            <h1>Debug Page</h1>
            <p>
                Try out your in-development components or other functionality on
                this page.
            </p>
                ...
                <b-tabs card>
                    <b-tab title="Search Bars">
                        <div class="page-section">
                            ...
                            <ul>
                                <li
                                    v-for="(a, idx) in selected_variants"
                                    :key="idx"
                                >
                                    {{ a }}
                                </li>
                            ...
                            <b-button @click="populateSearchBar"
                                >Populate Bar</b-button
                            >&nbsp;
                            <b-button type="button" @click="clearBar"
                                >Clear Bar</b-button
                            >
                        </div>
                        ...
                        <div class="page-section">
                            ...
                            <b-button @click="bare_value = 'C'"
                                >populate bare w/C</b-button
                            >
                        </div>
                        ...
                        <div class="page-section">
                            ...
                            <b-button @click="wrapped_value = 'C'"
                                >populate wrapped w/C</b-button
                            >
                        </div>
                    </b-tab>
                    ...
                    <b-tab title="Generic Tables">
                        <div class="page-section">
                            ...
                            <PagedTable
                                :apiUrl="`/curation_entries`"
                                :fields="curation_fields"
                            >
    ...
    methods: {
        ...
        populateSearchBar() {
            const item = {
                ...
                g_id: 1,
                type: "v",
                label: "EGFR L858R (c.2573T>G)",
                sources: ["civic", "cosmic", "oncokb"],
            };

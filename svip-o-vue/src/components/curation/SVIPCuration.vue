            ...
            <b-card no-body>
              ...
              >
                <b-tab title="Evidence" active>
                  <b-card-text>
                    <evidence-table :items="row.item.curation_entries" :variant="variant" />
                  </b-card-text>
                </b-tab>
                      ...
                      <template v-slot:cell(row-details)="entry">
                        ...
                        >
                          <table>
                            <tr>
                              <th
                                v-for="field in subtables.samples.tumor_fields"
                                :key="field.key"
                              >{{ field.label }}</th>
                            </tr>
                            <tr>
                        ...
                        >
                          <table>
                            <tr>
                              <th
                                v-for="field in subtables.samples.sequencing_fields"
                                :key="field.key"
                              >{{ field.label }}</th>
                            </tr>
                            <tr>
...
import evidenceTable from "@/components/curation/subtables/EvidenceTable";
...
export default {
  ...
  methods: {
    ...
    showPanel(row, tabIndex) {
      console.log(
        `Switching row ${row.item.name} from tab ${
          this.svip_entry_tabs[row.item.name]
        } to tab ${tabIndex}`
      );

<template>
	<div class="p-0 m-0">
		...
		<!--                    <b-table-->
		<!--                        v-for="(disease, index) in disease"-->
		<!--                        :key="index"-->
		<!--                        :fields="fields"-->
		...
		<!--                                <br />-->
		<!--                            </p>-->
		<!--                            &lt;!&ndash; Ivo : better to not include the number of evidences in the object and compute it here?-->
		...
		<!--                            &lt;!&ndash; Ivo : need to refresh if we add an evidence from a new tab? &ndash;&gt;-->
		<!--                            &lt;!&ndash; :href="addEntryURL()" &ndash;&gt;-->
		<!--                            <div align="center">-->
		<!--                                <b-button-->
		...
		<!--                        &lt;!&ndash; For transition: https://github.com/bootstrap-vue/bootstrap-vue/issues/5129 &ndash;&gt;-->
		<!--                        <template v-slot:row-details="row">-->
		<!--                            <b-table-->
		<!--                                :items="row.item.evidence"-->
		<!--                                :fields="footer"-->
		...
		<!--            <b-modal-->
		<!--                :id="addNoteID"-->
		<!--                :ref="evidence.sib_annotation_id"-->
...
export default {
	...
	methods: {
		...
		handleEffect(event) {
			...
			const selectedValue =
				document.getElementById(tag_id).childNodes[0].value !== undefined
					? document.getElementById(tag_id).childNodes[0].value
					: document.getElementById(tag_id).childNodes[1].value !== undefined
			...
			console.log('selected value', document.getElementById(tag_id).childNodes[0].value);
		...
		editEntryURL(entry) {
			...
			const [gene_id, variant_id] = [this.$route.params.gene_id, this.$route.params.variant_id];

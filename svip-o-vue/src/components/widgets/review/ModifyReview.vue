                            ...
                            <b-row>
                                <b-col
                                    ...
                                    <h5 class="mb-3">
                                        ...
                                        <a target="_blank" :href="`mailto:${review.reviewer_email}`">
                                            <b-icon icon="envelope" class="envelope"></b-icon>
                                        </a>
                                    </h5>
...
import {BIcon, BIconCheckSquareFill, BIconSquare, BIconXSquareFill, BIconEnvelope} from 'bootstrap-vue';

...
export default {
    ...
    methods: {
        ...
        makeItems() {
            ...
            this.raw_disease.map((evidence) => {
                ...
                if (typeof evidence.finalAnnotation === "undefined") {
                    ...
                    evidenceObj["sib_annotation_outcome"] =
                        evidence.curator.annotatedEffect;
                    evidenceObj["sib_annotation_trust"] =
                        evidence.curator.annotatedTier;
                    evidenceObj["clinical_input"] = "";
                } else {
                    evidenceObj["sib_annotation_outcome"] =
                        evidence.finalAnnotation.annotatedEffect;
                    evidenceObj["sib_annotation_trust"] =
                        evidence.finalAnnotation.annotatedTier;
                    evidenceObj["clinical_input"] =
                        evidence.finalAnnotation.clinical_input;

                    // use id of final_annotation object so that the PATCH request is made to the right ID
                    evidenceObj["final_annotation_id"] =
                        evidence.finalAnnotation.id;
                }
        ...
        addEvidence() {
            ...
            let new_route =
                route.href + "&variant_id=" + this.$route.params.variant_id;

<template>
    <b-form-select v-model="selection" class="form-control">
        <option>Tier IA: FDA/EMA/Swissmedic approved therapy</option>
        <option>
            Tier IA: Therapy included in Professional Guidelines such as NCCN or
            CAP
        </option>
        <option>
            Tier IB: Well-powered studies with consensus from experts in the
            field
        </option>
        <option>
            Tier IIC: FDA/EMA/Swissmedic approved therapy for a different tumor
            type
        </option>
        <option>Tier IIC: Small published studies with some consensus</option>

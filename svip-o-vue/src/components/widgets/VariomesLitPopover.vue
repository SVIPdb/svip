...
export default {
    ...
    methods: {
        ...
        updateCitation() {
            ...
            // on different pages...)
            if (this.variomesIsValid) return;
...
<style>
.variomes-popover .title {
    font-weight: bold;
}

.variomes-popover .abstract {
    max-height: 30ex;
    overflow: hidden;
}

.variomes-popover .authors {
    font-style: italic;
...
.variomes-popover .gene {
    color: #e3639f;
    font-weight: bold;
}

.variomes-popover .variant {
    color: #4b7bef;
    font-weight: bold;
}

.variomes-popover .disease {
    color: #3d811e;
    font-weight: bold;
}
</style>

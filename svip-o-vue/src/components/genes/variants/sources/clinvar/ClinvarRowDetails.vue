  ...
  <div class="row">
    <div class="col-xl-3 col-4">
      <b-card>
        <h6 class="card-subtitle mb-2 text-muted">
          ...
          <span class="float-right badge badge-primary filter-phenotype__term" v-if="currentFilter.phenotype__term" style="font-size: 13px">
    ...
    <div class="col-xl-9 col-8">
      <b-card>
        ...
        <b-table
          :fields="fields" class="table-sm filter-table" :api-url="row.item.associations_url" :items="assocation_provider"

<template>
    <div class='container'>
        ...
        <b-table striped hover :items="gene.files" :fields="fields" :sort-by.sync="sortBy" :sort-desc.sync="sortDesc"
                 :per-page="perPage" :current-page="currentPage" :filter="filter" @filtered='onFiltered'>

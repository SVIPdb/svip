    ...
    static get template() {
        return html`
            ...
            <div class="viewer-hdr">
                <span>
                    <input type="checkbox" on-change="_handle_checkbox_change" checked="[[showlinks]]" />
            ...
            <p>
                ...
                <template is="dom-if" if="{{_hasValue(publi.pmcid)}}">
                    <span>- PMCID:</span>
                    <a target="_blank" href="https://www.ncbi.nlm.nih.gov/pmc/articles/[[publi.pmcid]]/">
                        [[publi.pmcid]]
                    </a>
                </template>
                <template is="dom-if" if="{{_hasValue(publi.pmid)}}">
                    <span>- PMID:</span>
                    <a target="_blank" href="https://www.ncbi.nlm.nih.gov/pubmed/?term=[[publi.pmid]]">
                        [[publi.pmid]]
                    </a>
                </template>
                <template is="dom-if" if="{{_hasValue(publi.doi)}}">
                    <span>- DOI:</span>
                    <a target="_blank" href="https://dx.doi.org/[[publi.doi]]">[[publi.doi]]</a>
                </template>
            </p>
            <p>
                Author(s):
                ...
                <dom-repeat items="[[publi.affiliations]]">
                    <template>
                        <div class="publi-affiliation-div">
                            <span class="publi-affiliation-label">{{_getPmcaAffiliationLabel(index)}}</span>
                            [[item.name]]
                        </div>
                    </template>
                </dom-repeat>
            ...
            <dom-repeat items="[[publi.body_sections]]">
                <template>
                    ...
                    <pubmed-section-v2
                        ...
                        data="[[item]]"
                        fsccount="[[fsccount]]"
                        filters="[[filters]]"></pubmed-section-v2>
                </template>
            </dom-repeat>

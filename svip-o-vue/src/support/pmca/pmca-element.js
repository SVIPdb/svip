...
/*------------------------------*/
    ...
    <col1>
      <div class="content11" id="pmcid-selection-div" style="display:none;">
        ...
        <input id="pmcid_in" type="list" value="" list="pmcid-list" autocomplete="off" on-change="handleSelectPmcid" on-click="handleClickPS">
        <datalist id="pmcid-list">
          <option value="6622523"><option value="4235888"><option value="4909023"><option value="4476985"><option value="5244436"><option value="4094256">
          <option value="4235888"><option value="4909023"><option value="4476985"><option value="5244436"><option value="4094256"><option value="6066757"><option value="5364449"><option value="3265130">
        </datalist>
  ...
  fillViewerWithIdAndOptions(pmcid, options) {
    ...
    return promise.then(function (annotatedPubli) {
      ...
      lb.data = annotations;
      lb.fillList();
      var filters = DataParser.getPropertyValuesFromAnnotations(annotatedPubli.annotations, "concept_source");
  ...
  displayPmcid(id) {
    ...
    for (var i = 0; i < params.length; i++) {
      ...
      if (nv[0].toLowerCase() == "service" && nv.length == 2) new_params += "&service=" + nv[1].toLowerCase();
    }

...
export default function KeyboardDirectionMixin(Base) {
    ...
    class KeyboardDirection extends Base {
         ...
         */
        [symbols.goDown]() {
            if (super[symbols.goDown]) {
                return super[symbols.goDown]();
            }
        }
        /**
        ...
        [symbols.goEnd]() {
            if (super[symbols.goEnd]) {
                return super[symbols.goEnd]();
            }
        }
        /**
        ...
        [symbols.goLeft]() {
            if (super[symbols.goLeft]) {
                return super[symbols.goLeft]();
            }
        }
        /**
        ...
        [symbols.goRight]() {
            if (super[symbols.goRight]) {
                return super[symbols.goRight]();
            }
        }
        /**
        ...
        [symbols.goStart]() {
            if (super[symbols.goStart]) {
                return super[symbols.goStart]();
            }
        }
        /**
        ...
        [symbols.goUp]() {
            if (super[symbols.goUp]) {
                return super[symbols.goUp]();
            }
        }

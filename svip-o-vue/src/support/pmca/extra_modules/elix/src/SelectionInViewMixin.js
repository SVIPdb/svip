...
export default function SelectionInViewMixin(Base) {
  ...
  class SelectionInView extends Base {
    ...
    scrollSelectionIntoView() {
      ...
      const itemRect = selectedItem.getBoundingClientRect(); // Determine how far the item is outside the viewport.
      ...
      const rightDelta = itemRect.right - scrollTargetRect.right; // Scroll the target as necessary to bring the item into view.

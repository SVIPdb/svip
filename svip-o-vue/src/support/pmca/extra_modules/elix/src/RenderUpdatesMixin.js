...
export default function RenderUpdatesMixin(Base) {
    return class RenderUpdates extends Base {
        [symbols.beforeUpdate]() {
            if (super[symbols.beforeUpdate]) {
                super[symbols.beforeUpdate]();
            }
        }
        ...
        [symbols.render]() {
            ...
            this[symbols.beforeUpdate](); // Collect an updated set of properties/attributes.

            const updatesToApply = this.updates; // Apply those to the host.

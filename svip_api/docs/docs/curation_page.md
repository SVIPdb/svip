...
---|---|---|---
Disease||All ICD-O codes|International Classification of Diseases for Oncology (ICD-O)
Drug||International Nonproprietary Names (INN), IUPAC|INN is the source for the nomenclature of drugs used in clinical settings and obtained from WHO. Names provided in publications or by IUPAC are used only if the INN is missing.
Effect of the variant||Sensitive (in vitro)|Results from in vitro experiments are reported in this section only if they have been performed with a clinically relevant drug. For other drugs, see section "Biological relevance", subsection "Response to drug".
|||Responsive|Used to report the response to drug in patients.
|||Resistant (in vitro)|Results from in vitro experiments are reported in this section only if they have been performed with a clinically relevant drug. For other drugs, see section "Biological relevance", subsection "Response to drug".
...
Tier criteria|Tier I: variants with strong clinical significance;|Tier IA|Included in Professional Guidelines 
|||Tier IB|Well-powered studies with consensus from experts in the field
||Tier II: variants with potential clinical significance|Tier IIC|Small published studies with some consensus 
|||Tier IID |Population study
|||Tier IID|Clinical trial
|||Tier IID|Pre-clinical trial
|||Tier IID|Case reports
...
||Tier IV: reported evidence supportive of benign/likely benign effect||
||Other criteria||If none of the above apply
Tier level|Tier I|Variants with strong clinical significance
||Tier II|Variants with potential clinical significance
||Tier III|Variants of unknown clinical significance
||Tier IV|Variants with no clinical significance for disease prognosis
...
---|---|---
Disease||All ICD-O codes|Disease annotation is optional in this section. If experiments were done in patients’ cells, the tumor type is provided in publications. If experiments were done in established cell lines, the tumor type, is provided by American Type Culture Collection (ATCC) or Cellosaurus databases.
...
||Misexpression|
||Other|If none of the above apply
|Functional criteria|Well-established in vitro study|Studies are considered in vitro if they were performed in a test tube or in cultured cells.
||Well-established in vivo study|Studies are considered in vivo if they were performed in animals.
||Author statement|
||Other criteria|
|Support|Strong|
||Moderate|
...
|Functional criteria|Well-established in vitro study|Studies are considered in vitro if they were performed in a test tube or in cultured cells.
||Well-established in vivo study|Studies are considered in vivo if they were performed in animals.
||Prediction|Applies, for instance, when the mutated residue is located in the catalytic site or is known to be required for function.
||Author statement    |
||Other criteria|If none of the above apply
|Support|Strong|
||Moderate|
...
||International Nonproprietary Names (INN), IUPAC|Applies when the interactor is a drug. 
...
|Functional criteria|Well-established in vitro study|Studies are considered in vitro if they were performed in a test tube or in cultured cells.
||Well-established in vivo study|Studies are considered in vivo if they were performed in animals.
||Prediction|Applies, for instance, when the mutated residue is found in a binding domain.
||Author statement|
||Other criteria|
|Support|Strong|
||Moderate|
...
Field|Possible values|Comment
---|---|---
|Drug nomenclature|IUPAC or commonly used name|Drugs used in a clinical setting or having an INN are annotated in the section ‘Clinical significance - Predictive/Therapeutic’.
...
|Functional criteria|Well-established in vitro study|Studies are considered in vitro if they were performed in a test tube or in cultured cells.
||Well-established in vivo study|Studies are considered in vivo if they were performed in animals.
||Prediction|Applies, for instance, when the mutated residue known to be required for drug action.
||Author statement|
||Other criteria|If none of the above apply
|Support|Strong|
||Moderate|
...
|Functional criteria|Well-established in vitro study|Studies are considered in vitro if they were performed in a test tube or in cultured cells.
||Well-established in vivo study|Studies are considered in vivo if they were performed in animals.
||Prediction|Applies, for instance, when the mutated residue is found in a site known to target the protein to a specific subcellular location.
||Author statement|
||Other criteria|If none of the above apply
|Support|Strong|
||Moderate|

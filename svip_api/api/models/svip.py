...
class CurationRequest(SVIPModel):
    ...
    """
    related_name = 'curation_requests'

    submission = models.ForeignKey(
        'SubmittedVariant', on_delete=models.SET_NULL, null=True)
    variant = models.ForeignKey(
        to=Variant, on_delete=models.SET_NULL, null=True, related_name=related_name)
    disease = ForeignKey(to=Disease, on_delete=DB_CASCADE, related_name=related_name)
